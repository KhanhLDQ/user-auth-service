...
@Getter
public class ResendEmailEvent extends ApplicationEvent {
    ...
    @Builder
    public ResendEmailEvent(EventType eventType, LocalDateTime timestamp, String email, String verificationToken, long emailVerificationExpiry, String fullName) {
