...
public class PasswordResetEvent extends ApplicationEvent {
    ...
    @Builder
    public PasswordResetEvent(EventType eventType, LocalDateTime timestamp, String email, String verificationToken, long emailVerificationExpiry, String fullName) {
